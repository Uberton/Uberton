...
DEF_CLASS2(INLINE_UID_FROM_FUID(Uberton::ManualGui::ProcessorUID),
	...
	Uberton::ManualGui::Processor::createInstance);		// function pointer called when this component should be instantiated

DEF_CLASS2(INLINE_UID_FROM_FUID(Uberton::ManualGui::ControllerUID),
	PClassInfo::kManyInstances,						// cardinality
